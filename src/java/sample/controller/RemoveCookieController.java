...
public class RemoveCookieController extends HttpServlet {
    ...
    private static final String cart = "shoping-cart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null && proID != null) {
                    String[] products = request.getParameterValues("name");
                    String[] proIDs = request.getParameterValues("name");
                    if(products!=null){
                    ...
                    if(proIDs!= null){
                        for(String proId : proIDs){
                            proID.removeProID(proId);
                        }
                        session.setAttribute("PROID_CART", proID);
                    }
                }
            }
        } catch (Exception e) {
